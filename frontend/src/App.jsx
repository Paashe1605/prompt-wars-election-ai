...
const uiTranslations = {
  ...
  Gujarati: { appTitle: "વૈશ્વિક ચૂંટણી નેવિગેટર", appSubtitle: "તમારો નિષ્પક્ષ ચૂંટણી માર્ગદર્શક", currentLocation: "વર્તમાન સ્થાન", verified: "ચકાસાયેલ", preferredLanguage: "પસંદગીની ભાષા", retrieveBtn: "ચૂંટણી ડેટા મેળવો", loadingCoordinates: "કોઓર્ડિનેટ્સ મેળવી રહ્યા છીએ...", generatingIntel: "માહિતી જનરેટ થઈ રહી છે...", audioBriefing: "ઓડિયો બ્રીફिंग", electionTimelines: "ચૂંટણી સમયરેખા", saveToCalendar: "કેલેન્ડરમાં સાચવો", votingProcedures: "મતદાન પ્રક્રિયાઓ", helpfulResources: "ઉપયોગી સંસાધનો", infoSynthesizedFor: "માટે માહિતી સંશ્લેષિત:", countdownTitle: "આગામી ચૂંટણી સુધીનો સમય", days: "દિવસ", hours: "કલાક", minutes: "મિનિટ", seconds: "સેકન્ડ", findPollingStation: "નજીકનું મતદાન કેન્દ્ર", shareOnWhatsApp: "માર્ગદર્શિકા શેર કરો", politicalLandscape: "રાજકીય લેન્ડસ્કેપ", currentLeadership: "વર્તમાન નેતૃત્વ", keyCandidates: "મુખ્ય ઉમેદવારો", awaitingNomination: "નોમિનેશનની રાહ જોવાઈ રહી છે" },
  Marathi: { appTitle: "जागतिक निवडणूक मार्गदर्शक", appSubtitle: "तुमचा नि:पक्षपाती निवडणूक मार्गदर्शक", currentLocation: "सध्याचे स्थान", verified: "सत्यापित", preferredLanguage: "पसंतीची भाषा", retrieveBtn: "निवडणूक डेटा मिळवा", loadingCoordinates: "कोऑर्डिनेट्स मिळवत आहे...", generatingIntel: "माहिती व्युत्पन्न करत आहे...", audioBriefing: "ऑडिओ ब्रीफिंग", electionTimelines: "निवडणूक वेळापत्रक", saveToCalendar: "कॅलेंडरमध्ये जतन करा", votingProcedures: "मतदान प्रक्रिया", helpfulResources: "उपयुक्त संसाधने", infoSynthesizedFor: "यासाठी माहिती संश्लेषित केली:", countdownTitle: "पुढील निवडणुकीपर्यंतची वेळ", days: "दिवस", hours: "तास", minutes: "मिनिटे", seconds: "सेकंड", findPollingStation: "जवळचे मतदान केंद्र", shareOnWhatsApp: "मार्गदर्शक सामायिक करा", politicalLandscape: "राजकीय परिदृश्य", currentLeadership: "सध्याचे नेतृत्व", keyCandidates: "प्रमुख उमेदवार", awaitingNomination: "नामांकनाची प्रतीक्षा" },
